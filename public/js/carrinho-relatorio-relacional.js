"use strict";
const produtosRelatorio = ['Camiseta Básica', 'Camiseta Polo', 'Bermuda Moletom', 'Calça Jeans Masculina',
    'Camiseta Básica', 'Calça Jeans Feminina', 'Camiseta Básica', 'Camiseta Polo', 'Bermuda Moletom'
];
const precosRelatorio = [29.90, 49.90, 35, 89.99, 29.90, 109.99, 29.90, 49.90, 35];
let camisetaBasica = 0;
let camisetaPolo = 0;
let bermudaMoleton = 0;
let calcaJeansMasculina = 0;
let calcaJeansFeminina = 0;
let precoCamisetaBasica = "";
let precoCamisetaPolo = "";
let precoBermudaMoleton = "";
let precoCalcaJeansMasculina = "";
let precoCalcaJeansFeminina = "";
